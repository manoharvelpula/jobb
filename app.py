...
if st.session_state.analyze_clicked:
    ...
    if not selected_skills:
        ...
        def generate_pdf_bytes():
            ...
            pdf.cell(200, 10, txt=clean_text("Career Report"), ln=True)
            pdf.cell(200, 10, txt=clean_text(f"Best Role: {best_role}"), ln=True)
            pdf.cell(200, 10, txt=clean_text(f"Salary: {salary_data[best_role]}"), ln=True)

            pdf.cell(200, 10, txt="Skills:", ln=True)
            for skill in selected_skills:
                pdf.cell(200, 10, txt=clean_text(skill), ln=True)
...
# ---------------- FOOTER ----------------
st.markdown("---")
st.caption("AI Career Intelligence PRO")
